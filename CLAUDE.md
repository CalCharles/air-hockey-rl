...
- **Goal-conditioned tasks + HER**: [`training/her.md`](notes/docs/training/her.md) — sparse puck-goal position / position+velocity tasks, hindsight relabelling, eval
