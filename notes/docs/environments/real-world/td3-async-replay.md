...
Training on hardware uses the async TD3 collector/learner path (shared-memory replay), not the synchronous vec-env script [`td3_training.py`](../../../../scripts/td3/td3_training.py).

| Piece | Location |
|-------|----------|
| Async real TD3 (collector + learner) — entrypoint | [`scripts/td3/extras/async_td3_real.py`](../../../../scripts/td3/extras/async_td3_real.py) |
| Shared runtime library (Args, learner step, helpers) | [`scripts/td3/helper/real_td3_runtime.py`](../../../../scripts/td3/helper/real_td3_runtime.py) |
| Shared replay (success/failure partitions) | [`scripts/td3/helper/shared_replay.py`](../../../../scripts/td3/helper/shared_replay.py) |
| Sim TD3 reference (naming and bootstrap) | [`td3_training.py`](../../../../scripts/td3/td3_training.py) |
...
Current code stores **only** `dones`, with the **critic** semantics above (same as [`TD3ReplayBuffer`](../../../../scripts/td3/helper/replay_buffer.py) in the sim trainer).
