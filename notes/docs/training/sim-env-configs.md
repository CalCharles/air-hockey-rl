...
### `sysid_best_params.yaml` — System-ID best-fit (canonical)
The canonical sim config: physics tuned to match real-world dynamics via system identification. Use this for new runs.
