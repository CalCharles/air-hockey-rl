...
Config files live in `scripts/smooth_policy/amp_history/configs/td3_real_world/`. Used for training, evaluation, teleoperation, and the user study on the real UR5 robot.
