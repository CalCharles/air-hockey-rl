...
Starts every episode with the puck near the top of the table (puck_spawn_near_paddle_prob=0). Removes the 15% near-paddle starts from the canonical 85/15 mixture. Tests whether the warm-start curriculum matters.
...
| Source checkpoint | `runs/td3/zeroshot_ablations_700k/start_100_near_top/seed0/checkpoint_675000/training_state.pth` |
| Training step at this ckpt | 675,000 |
| Source run dir | `runs/td3/zeroshot_ablations_700k/start_100_near_top/seed0` |
| Sim config (Box2D env) | `scripts/smooth_policy/amp_history/configs/new_juggle/zeroshot_ablations/sim_start_100_near_top.yaml` |
| TD3 args (recipe) | `scripts/smooth_policy/amp_history/configs/td3/zeroshot_ablations_700k/td3_zeroshot_start_100_near_top_extend.yaml` |
...
- `puck_spawn_near_paddle_prob: 0.0` (was 0.15)

### Training metric at the picked checkpoint

- Step 676000: Rolling(2k) Avg Return = 101.47, Success Rate = 0.80, Avg Episode Length = 148.93 (single-env training-time metric)
