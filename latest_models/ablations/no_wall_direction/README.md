...
Disables WALL collision direction randomization (±10° puck-wall bounce-angle cone). Tests whether wall-bounce angle stochasticity matters for transfer.
...
| Source checkpoint | `runs/td3/zeroshot_ablations_700k/no_wall_direction/seed0/checkpoint_675000/training_state.pth` |
| Training step at this ckpt | 675,000 |
| Source run dir | `runs/td3/zeroshot_ablations_700k/no_wall_direction/seed0` |
| Sim config (Box2D env) | `scripts/smooth_policy/amp_history/configs/new_juggle/zeroshot_ablations/sim_no_wall_direction.yaml` |
| TD3 args (recipe) | `scripts/smooth_policy/amp_history/configs/td3/zeroshot_ablations_700k/td3_zeroshot_no_wall_direction_extend.yaml` |
...
- Step 676000: Rolling(2k) Avg Return = 74.82, Success Rate = 0.76, Avg Episode Length = 118.29 (single-env training-time metric)
