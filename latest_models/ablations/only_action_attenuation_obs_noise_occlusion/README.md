...
Isolation study: action attenuation + puck noise + occlusions ON; collision randomization (×3) and delay-jitter OFF. Tests the union of perception + actuator randomization without any collision-physics noise.
...
| Source checkpoint | `runs/td3/zeroshot_ablations_700k/only_action_attenuation_obs_noise_occlusion/seed0/checkpoint_675000/training_state.pth` |
| Training step at this ckpt | 675,000 |
| Source run dir | `runs/td3/zeroshot_ablations_700k/only_action_attenuation_obs_noise_occlusion/seed0` |
| Sim config (Box2D env) | `scripts/smooth_policy/amp_history/configs/new_juggle/zeroshot_ablations/sim_only_action_attenuation_obs_noise_occlusion.yaml` |
| TD3 args (recipe) | `scripts/smooth_policy/amp_history/configs/td3/zeroshot_ablations_700k/td3_zeroshot_only_action_attenuation_obs_noise_occlusion.yaml` |
...
- Step 676000: Rolling(2k) Avg Return = 70.95, Success Rate = 0.63, Avg Episode Length = 112.95 (single-env training-time metric)
