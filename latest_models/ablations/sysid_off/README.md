...
Reverts the 5 sysid-tuned physics parameters back to legacy off-the-shelf values to test how much real-world system identification matters for transfer.
...
| Source checkpoint | `runs/td3/zeroshot_ablations_700k/sysid_off/seed0/checkpoint_675000/training_state.pth` |
| Training step at this ckpt | 675,000 |
| Source run dir | `runs/td3/zeroshot_ablations_700k/sysid_off/seed0` |
| Sim config (Box2D env) | `scripts/smooth_policy/amp_history/configs/new_juggle/zeroshot_ablations/sim_sysid_off.yaml` |
| TD3 args (recipe) | `scripts/smooth_policy/amp_history/configs/td3/zeroshot_ablations_700k/td3_zeroshot_sysid_off_extend.yaml` |
...
- Sysid REPLACED with legacy values: paddle_density 3000→1000, gravity -0.661→-0.65, puck_damping 0.178→0.25, pid_kp 9000→5000, pid_kd 50→200

### Training metric at the picked checkpoint

- Step 676000: Rolling(2k) Avg Return = 123.17, Success Rate = 0.92, Avg Episode Length = 187.00 (single-env training-time metric)
