# no_paddle_puck_strength

## High-level description

Disables paddle-puck collision STRENGTH randomization (impulse magnitude × U[0.5, 1.0]). Direction-cone randomization stays on. Tests whether stochastic restitution is necessary for transfer.
...
| Source checkpoint | `runs/td3/zeroshot_ablations_700k/no_paddle_puck_strength/seed0/checkpoint_675000/training_state.pth` |
| Training step at this ckpt | 675,000 |
| Source run dir | `runs/td3/zeroshot_ablations_700k/no_paddle_puck_strength/seed0` |
| Sim config (Box2D env) | `scripts/smooth_policy/amp_history/configs/new_juggle/zeroshot_ablations/sim_no_paddle_puck_strength.yaml` |
| TD3 args (recipe) | `scripts/smooth_policy/amp_history/configs/td3/zeroshot_ablations_700k/td3_zeroshot_no_paddle_puck_strength_extend.yaml` |
...
- Step 676000: Rolling(2k) Avg Return = 94.21, Success Rate = 0.71, Avg Episode Length = 147.57 (single-env training-time metric)
