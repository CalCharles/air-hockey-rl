# no_action_attenuation

## High-level description

Disables stochastic action-force attenuation (the canonical setup randomly drops commanded paddle force to 25-75% with 30% probability per step). Tests whether actuator-noise simulation is necessary for transfer.
...
| Source checkpoint | `runs/td3/zeroshot_ablations_700k/no_action_attenuation/seed0/checkpoint_675000/training_state.pth` |
| Training step at this ckpt | 675,000 |
| Source run dir | `runs/td3/zeroshot_ablations_700k/no_action_attenuation/seed0` |
| Sim config (Box2D env) | `scripts/smooth_policy/amp_history/configs/new_juggle/zeroshot_ablations/sim_no_action_attenuation.yaml` |
| TD3 args (recipe) | `scripts/smooth_policy/amp_history/configs/td3/zeroshot_ablations_700k/td3_zeroshot_no_action_attenuation_extend.yaml` |
...
- Step 676000: Rolling(2k) Avg Return = 100.85, Success Rate = 0.85, Avg Episode Length = 157.00 (single-env training-time metric)
