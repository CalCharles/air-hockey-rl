# start_100_near_paddle

## High-level description

Starts every episode with the puck near the paddle (puck_spawn_near_paddle_prob=1.0). Inverts the 85/15 default — now no near-top starts. Tests the opposite extreme of the start-state curriculum.
...
| Source checkpoint | `runs/td3/zeroshot_ablations_700k/start_100_near_paddle/seed0/checkpoint_675000/training_state.pth` |
| Training step at this ckpt | 675,000 |
| Source run dir | `runs/td3/zeroshot_ablations_700k/start_100_near_paddle/seed0` |
| Sim config (Box2D env) | `scripts/smooth_policy/amp_history/configs/new_juggle/zeroshot_ablations/sim_start_100_near_paddle.yaml` |
| TD3 args (recipe) | `scripts/smooth_policy/amp_history/configs/td3/zeroshot_ablations_700k/td3_zeroshot_start_100_near_paddle_extend.yaml` |
...
- `puck_spawn_near_paddle_prob: 1.0` (was 0.15)

### Training metric at the picked checkpoint

- Step 676000: Rolling(2k) Avg Return = 107.83, Success Rate = 0.83, Avg Episode Length = 168.92 (single-env training-time metric)
