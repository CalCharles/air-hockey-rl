...
Disables random puck-observation occlusions (the canonical setup drops puck observations at 2.5%/step rate, with 3× boost near the paddle). Tests whether vision-dropout simulation is necessary for transfer.
...
| Source checkpoint | `runs/td3/zeroshot_ablations_700k/no_occlusions/seed0/checkpoint_675000/training_state.pth` |
| Training step at this ckpt | 675,000 |
| Source run dir | `runs/td3/zeroshot_ablations_700k/no_occlusions/seed0` |
| Sim config (Box2D env) | `scripts/smooth_policy/amp_history/configs/new_juggle/zeroshot_ablations/sim_no_occlusions.yaml` |
| TD3 args (recipe) | `scripts/smooth_policy/amp_history/configs/td3/zeroshot_ablations_700k/td3_zeroshot_no_occlusions_extend.yaml` |
...
- Step 676000: Rolling(2k) Avg Return = 102.00, Success Rate = 0.92, Avg Episode Length = 153.54 (single-env training-time metric)
