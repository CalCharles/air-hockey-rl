...
Run: identical to td3_training.py.
    python -m scripts.smooth_policy.amp_history.amp_training.td3.td3_training_dr \
...
from scripts.smooth_policy.amp_history.amp_training.td3 import td3_training
...
def _rollout_returns(
    ...
    in scripts/smooth_policy/evaluate.py but skips frame capture and
