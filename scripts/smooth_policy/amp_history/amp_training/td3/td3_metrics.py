...
def initialize_train_metrics() -> Dict[str, float]:
    return {
        ...
        "rewards/sampled_task_reward_min": 0.0,
        "rewards/sampled_task_reward_std": 0.0,
        "rewards/sampled_task_reward_positive_count": 0.0,
        "rewards/sampled_task_reward_positive_fraction": 0.0,
        "rewards/sampled_task_reward_positive_mean": 0.0,
        "rewards/sampled_task_reward_positive_std": 0.0,
