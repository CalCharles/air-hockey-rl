...
from scripts.smooth_policy.visualize_demo.replay_real_in_sim import replay_episode

INPUT_PATH = _REPO_ROOT / "sysid" / "teleop" / "trajectory_data3.hdf5"
OUTPUT_ROOT = _REPO_ROOT / "sysid" / "teleop" / "system_id3"
SIM_CONFIG = str(
    _REPO_ROOT
...
CATEGORIES = [
    ("side_to_side_fast",    101,  300),
    ("side_to_side_slow",    325,  600),
    ("side_to_side_dynamic", 650,  900),
    ("up_and_down_fast",     960,  1200),
    ("up_and_down_slow",     1275, 1550),
    ("up_and_down_dynamic",  1590, 1760),
    ("diagonal_fast",        1790, 2000),
    ("diagonal_dynamic",     2025, 2200),
    ("circle_fast",          2235, 2650),
    ("circle_slow",          2680, 3170),
    ("random",               3225, 3525),
]
