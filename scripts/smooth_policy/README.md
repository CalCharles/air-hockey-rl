...
- Collector hold driven from [`amp_history/amp_training/td3/extras/async_td3_real.py`](amp_history/amp_training/td3/extras/async_td3_real.py) using the `TransitionHoldState` helper in [`real_transition_hold.py`](amp_history/amp_training/td3/helper/real_transition_hold.py)
