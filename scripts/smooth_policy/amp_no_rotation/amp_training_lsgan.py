...
# AMP components
from scripts.smooth_policy.amp_no_rotation.discriminator import Discriminator
...
if __name__ == "__main__":
    ...
    if args.use_reference_state_init:
        ...
        # Extract first state of each pair: [N, 4] = [x, y, vx, vy]
        reference_states = raw_data['state_pairs'][:, 0, :].numpy()
        print(f"✓ Loaded {len(reference_states):,} reference states")
