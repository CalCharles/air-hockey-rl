...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default="scripts/domain_adaptation/custom_config/", help='Folder that contains model and model_cfg.')
    parser.add_argument('--save-dir', type=str, default="scripts/domain_adaptation/custom_config/", help='Path to save the evaluation gifs to.')
