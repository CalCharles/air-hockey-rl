...
def run_single_episode(model_path, param_vector, param_names, action_sequence, 
    ...
    # previous while loop condition puck: (ground_truth and not done) or (not ground_truth and not done and (episode_length < traj_length))
    # paddle: (ground_truth and not done) or (not ground_truth and episode_length < len(action_sequence)
    while (ground_truth and not done) or (not ground_truth and episode_length < len(action_sequence)): # or episode_length < len(action_sequence)
    ...
    #   print("Getting states here in run_single_episode ", states)  create_action_plot(actions, model_path, plot_dir)
    results = {
