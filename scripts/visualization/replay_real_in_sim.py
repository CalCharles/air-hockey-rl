...
Usage:
    python scripts/visualization/replay_real_in_sim.py
    python scripts/visualization/replay_real_in_sim.py --episode path/to/trajectory.hdf5
    python scripts/visualization/replay_real_in_sim.py --enable-noise
"""
...
DEFAULT_CONFIG = "configs/new_juggle/sysid_best_params_hist2.yaml"
