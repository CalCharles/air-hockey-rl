...
class CollectAirHockey():
    ...
    def collect_env_data_random_action(self, air_hockey_cfg_fp, log_dir):
        """
        Evaluate the performance of an air hockey model using Stable Baselines.
        Note: This evalutes the latest training directory in the tensorboard log directory. 
        TODO: May need to change this later!
...
class CollectPointMaze():
    ...
    def collect_env_data_random_action(self, log_dir):
        """
        Evaluate the performance of an air hockey model using Stable Baselines.
        Note: This evalutes the latest training directory in the tensorboard log directory. 
        TODO: May need to change this later!
...
if __name__ == '__main__':  
    # pointmaze = CollectPointMaze()
    # pointmaze.train_env_model()
    # pointmaze.collect_env_data_trained_network(log_dir='/nfs/homes/air_hockey/cathy_air_hockey/PointMazeTrainedNetwork/', model_fp = 'baseline_models/PointMaze/PointMaze_7/model.zip')
    # pointmaze.collect_env_data_random_action(log_dir='/nfs/homes/air_hockey/cathy_air_hockey/PointMazeRandomAction')
    # pointmaze.collect_env_data_random_network(log_dir='/nfs/homes/air_hockey/cathy_air_hockey/PointMazeRandomNetwork')
