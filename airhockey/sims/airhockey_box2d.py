...
class AirHockeyBox2D:
    def __init__(self,
        ...
        self.task = task
        if task in ['puck_vel', 'puck_juggle', 'puck_catch', 'puck_touch', 'puck_reach',
                    'strike', 'goal_position', 'goal_position_velocity', 'puck_height',
                    'goal_position_dense', 'goal_position_velocity_dense']:
