...
class AirHockeyPuckGoalPositionEnv(AirHockeyGoalEnv):
    ...
    def compute_reward(self, achieved_goal, desired_goal, info):
        ...
        bonus = 10.0 if self.current_timestep > self.falling_time else 0.0 # this prevents the falling initiliazwed puck from triggering a success
    ...
    def get_base_reward(self, state_info):
        ...
        success = reward > 0.0
        self.success = success.item()
        # print(reward, success)
        return reward, self.success