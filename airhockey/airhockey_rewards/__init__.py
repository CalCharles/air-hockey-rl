from .airhockey_hierarchical_task_rewards import (
    AirHockeyMoveBlockReward,
...
from .goal_task_rewards import AirHockeyPaddleReachPositionNegRegionsReward, AirHockeyPaddleReachPositionReward, AirHockeyPaddleReachPositionSparseReward, AirHockeyPaddleReachPositionVelocityReward, AirHockeyPuckGoalPositionDynamicNegRegionsReward, AirHockeyPuckGoalPositionReward, AirHockeyPuckGoalPositionVelocityReward, AirHockeyPuckGoalPositionSparseReward, AirHockeyPuckGoalPositionVelocitySparseReward, AirHockeyPuckGoalPositionSpeedSparseReward
