...
class AirHockeyPuckGoalPositionDynamicNegRegionsReward(AirHockeyRewardBase):
    ...
    def compute_reward(self, achieved_goal, desired_goal, info):
        ...
        if self.task_env.dense_goal:
            bonus = 10 if self.task_env.current_timestep > self.task_env.falling_time else 0
